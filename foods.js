...
window.FOODS = [
  ...
  // World / Middle-Eastern dishes
  f("biryani",  "Chicken biryani", "برياني دجاج",        190, 8,   24,  7,   [s("1 plate","طبق",350), s("1 cup","كوب",200), s("100 g","100 غرام",100)]),
  f("mansaf",   "Mansaf",          "منسف",              185, 9,   20,  8,   [s("1 plate","طبق",400), s("100 g","100 غرام",100)]),
  f("koshari",  "Koshari",         "كشري",              150, 5,   27,  3,   [s("1 plate","طبق",300), s("1 cup","كوب",185), s("100 g","100 غرام",100)]),
  f("kabsa",    "Kabsa",           "كبسة",              160, 9,   20,  5,   [s("1 plate","طبق",350), s("100 g","100 غرام",100)]),
  f("maqluba",  "Maqluba",         "مقلوبة",            170, 7,   22,  6,   [s("1 plate","طبق",350), s("100 g","100 غرام",100)]),
  f("mujadara", "Mujadara",        "مجدرة",             150, 5,   24,  4,   [s("1 cup","كوب",200), s("100 g","100 غرام",100)]),
  f("warak_enab","Stuffed grape leaves","ورق عنب",       200, 3,   22,  11,  [s("1 piece","حبة",25), s("100 g","100 غرام",100)]),
  f("manakish", "Manakish za'atar","مناقيش زعتر",        280, 7,   36,  12,  [s("1 piece","قرص",120), s("100 g","100 غرام",100)]),
  f("tabbouleh","Tabbouleh",       "تبولة",             120, 2.5, 13,  7,   [s("1 cup","كوب",130), s("100 g","100 غرام",100)]),
  f("fattoush", "Fattoush",        "فتوش",              85,  2,   9,   5,   [s("1 bowl","طبق",150), s("100 g","100 غرام",100)]),
  f("sushi",    "Sushi",           "سوشي",              145, 5,   28,  1.5, [s("1 piece","قطعة",30), s("1 roll (6 pc)","لفة (٦ قطع)",180), s("100 g","100 غرام",100)]),
  f("fried_rice","Fried rice",     "أرز مقلي",          163, 4,   23,  6,   [s("1 cup","كوب",200), s("1 plate","طبق",300), s("100 g","100 غرام",100)]),
  f("noodles",  "Stir-fried noodles","نودلز مقلية",      150, 5,   24,  4,   [s("1 bowl","طبق",250), s("100 g","100 غرام",100)]),
  f("ramen",    "Ramen",           "رامن",              145, 6,   19,  5,   [s("1 bowl","طبق",450), s("100 g","100 غرام",100)]),
  f("curry",    "Chicken curry",   "كاري دجاج",          150, 9,   6,   10,  [s("1 cup","كوب",240), s("100 g","100 غرام",100)]),
  f("dumplings","Dumplings",       "دامبلينغ",          220, 8,   25,  9,   [s("1 piece","حبة",25), s("100 g","100 غرام",100)]),
  f("tacos",    "Taco",            "تاكو",              210, 9,   20,  10,  [s("1 taco","تاكو",100), s("100 g","100 غرام",100)]),
  f("sushi_roll","Sushi roll (California)","لفة سوشي كاليفورنيا", 130, 4, 23, 3, [s("1 roll (8 pc)","لفة (٨ قطع)",200), s("1 piece","قطعة",25), s("100 g","100 غرام",100)]),
